        ...
        builder: (context, storesSnap) {
          ...
          return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
            ...
            builder: (context, ordersSnap) {
              ...
              // Aggregation Map: "dd/MM/yyyy" or "MM/yyyy" -> total revenue
              ...
              for (final doc in orders) {
                ...
                groupedData.putIfAbsent(
                    dateKey, () => _RevenueData(sortKey: sortKey));
                          ...
                          return Card(
                            ...
                            child: Theme(
                              ...
                              child: ExpansionTile(
                                ...
                                children: entry.value.orders.map((order) {
                                  return Column(
                                    children: [
                                        ...
                                        trailing: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              ...
                                              style: TextStyle(
                                                fontSize: 10,
                                                color: order.status.toLowerCase() == 'paid' || order.status.toLowerCase() == 'completed'
                                                    ? Colors.green
                                                    : Colors.orange,
                                              ),
                                            ),
